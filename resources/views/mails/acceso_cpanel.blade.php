																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="{{url('/')}}" target="_blank"><img src="{{asset('img/logo-horizontal.png')}}" width="300px" border="0" alt="" /></a>
																			</td>
																		</tr>
																	</table>
																	<!-- Logo -->
																						...
																						<td class="pb-50" style="padding-bottom: 25px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                ...
                                                                                                <tr>
																									...
																									<td class="title-36 a-center pb-15" style="font-size:20px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
																										<strong>Tu datos de acceso a Cpanel son los siguientes:</strong>
																									</td>
                                                                                                ...
                                                                                                <tr>
																									...
																									<td class="title-36 pb-15" style="font-size:20px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; padding-bottom: 15px;">
																										<strong > Dominio: <span style="color:#005AD2">https://dominio.com/cpanel</span> </strong>
																									</td>
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																...
																<tr>
																	<td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                        © @php echo date('Y');@endphp WEBCOMPANY.
																		<br />
