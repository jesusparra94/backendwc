...
<head><meta charset="gb18030">
	...
	<!--<![endif]-->
	<title>Webcompany SpA - Servicios Ofrecidos</title>
	...
	<style type="text/css" media="screen">
		...
		a { color:#17A4F3; text-decoration:none }
		...
		.l-pink a { color: #17A4F3; }
		.l-grey a { color: #6e6e6e; }
		.l-purple a { color: #9128df; }

		.gradient { background: linear-gradient(to right, #17A4F3 0%,#005AD2 100%); }

		.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #17A4F3 0%,#005AD2 100%); }
...
<body class="body" style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#eee; -webkit-text-size-adjust:none;">
	<center>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#EEE" class="gwfw">
			<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="mpx-10">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="gradient pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;" bgcolor="#17A4F3">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																						...
																						<td class="pb-50" style="padding-bottom: 25px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                ...
                                                                                                <tr>
																									...
																									<td class="title-36 pb-15" style="font-size:16px; line-height:22px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; padding-bottom: 15px;text-align:center;">
																									Adicionalmente ofrecemos servicios de desarrollo web profesional.
																									</td>
																								...
																								<tr>
																									...
																									<td class="title-30 a-center pb-15" style="font-size:16px; line-height:40px; color:#2597EE; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 5px;">
																										<strong>¿Tienes una idea en mente y no sabes cómo materializarla?</strong>
																									</td>
																								...
																								<tr>
																									<td class="title-36 a-center pb-15" style="font-size:21px; line-height:30px; color:#2597EE; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
																										<strong>Nuestro objetivo es ofrecerte el mejor servicio</strong>
																									</td>

																								</tr>

																								<tr>
																									<td class="title-36 a-center pb-15" style="font-size:25px; line-height:30px; color:#7B47CF; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
																										<strong>Visitanos en <a style="color:#7B47CF;" href="https://webcompany.cl" target="_blank">webcompany.cl</a></strong>
																									</td>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="gradient p-50 mpx-15" style="border-radius: 0 0 10px 10px; padding: 12px;">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																...
																<tr>
																	<td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                        © @php echo date('Y');@endphp Web Company SpA.
																		<br />
